...
describe('Language Endpoints', () => {
  ...
  const [testLanguages, testWords] = helpers.makeLanguagesAndWords(
    testUser,
  );
    ...
    context(`Given correct guess`, () => {
      ...
      it(`responds with correct and moves head`, () => {
        ...
        return supertest(app)
          ...
          .expect(200)
          .expect({
            nextWord: testLanguagesWords_[1].original,
            totalScore: 1,
            wordCorrectCount: 0,
            wordIncorrectCount: 0,
            answer: testLanguagesWords_[0].translation,
            isCorrect: true,
          });
      });
